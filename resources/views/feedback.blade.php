        ...
        <div class='max-w-[1000px] w-full grid grid-cols-2 gap-8'>
          ...
          <div class='max-w-[1000px] w-full grid sm:grid-cols-2 gap-8 px-4'>
            <form action="#" method="POST" class="grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
              ...
              <div class="sm:col-span-2">
                <label for="company" class="block text-sm font-medium text-gray-700">Image</label>
                <div class="mt-1">
                  <input type="file" name="company" id="company" autocomplete="organization" class="py-3 px-4 block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md">
                </div>
              </div>
              <div class="sm:col-span-2">
    ...
    <footer class="bg-black">
      <div class="max-w-7xl mx-auto py-5 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
          ...
          <a href="#" class="text-gray-400 hover:text-gray-500">
            ...
            <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              <path fill-rule="evenodd"
                d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h5.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z"
                clip-rule="evenodd" />
            </svg>
          </a>
        ...
        <div class="mt-8 md:mt-0 md:order-1">
          <p class="text-center text-base text-gray-400">&copy; 2020 METATRANS, Inc. All rights reserved.</p>
        </div>
      </div>
    </footer>
  </x-app-layout>
