...
<div id="home" name='home' class='w-full h-screen bg-[#ccd6f6]'>
  <div class='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
    <div>
      <h1 class='text-5xl sm:text-8xl font-bold font-serif inline border-b-4 border-pink-600 '>MetaTrans</h1>
    </div>
    <br>

    <h4 class=' sm:text-lg font-sans text-gray-500 py-4 max-w-[700px]'>
    ...
    <div>
      <a class="leading-none" href="/login">
        <button 
          class='text-slate-900 group border-2 px-6 py-3 my-2 flex items-center hover:bg-pink-600 hover:border-pink-600 hover:text-white'>
        Booking!
