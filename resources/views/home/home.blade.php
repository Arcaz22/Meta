...
<div id="home" name='home' class='w-full h-screen bg-[#ccd6f6]'>
  <div class='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
    ...
    <h4 class=' font-sans text-gray-800 py-4 max-w-[700px]'>
    ...
    <div>
      <a class="leading-none" href="/login">
        <button 
          class='text-slate-800 font-medium group border-2 px-6 py-3 my-2 flex items-center hover:bg-pink-600 hover:border-pink-600 hover:text-white'>
        Pesan
