<div class="flex items-center" x-data="picturePreview()">
    <div class="rounded-md bg-gray-200 mr-2">
        <img src="img/default.png" id="preview" alt="" class="w-24 h-24 rounded-md object-cover">
    </div>
    <div>
        <x-primary-button class="relative" @click="document.getElementById('picture').click()">
