...
<body>
  <!-- navbar -->
  <nav class="bg-rose-500 fixed w-full h-[60px] flex justify-between items-center px-4">
    ...
    <ul
      ...
      <li><a class="text-sm text-rose-200 hover:text-rose-50" href="/home">HOME</a></li>
  ...
  <div class="navbar-menu relative z-50 hidden">
    ...
    <nav class="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto">
      ...
      <div>
        <ul>
          <li class="mb-1">
            <a class="block p-4 text-sm font-semibold text-gray-400 hover:bg-rose-50 hover:text-rose-600 rounded"
              href="/home">Home</a>
          </li>
          <li class="mb-1">
            <a class="block p-4 text-sm font-semibold text-gray-400 hover:bg-rose-50 hover:text-rose-600 rounded"
  ...
  <footer class="bg-rose-500">
    <div class="max-w-7-xl mx-auto py-3 px-4 sm:px-2 md:flex md:items-center md:justify-between lg:px-8">
      <div class="flex justify-center space-x-6 md:order-2">
        <a href="#" class="text-rose-200 hover:text-rose-50">
      ...
      <div class="mt-8 md:mt-0 md:order-1 pt-3">
        <p class="text-center text-base text-rose-200">&copy; 2020 METATRANS, Inc. All rights reserved.</p>
      </div>
    </div>
    </footer>

<script src=@vite('resources/js/index.js')></script>
</body>
